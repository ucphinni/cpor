<!--- GUARDRAILS - DO NOT ALTER WITHOUT REVIEW - START --->

# Async Database Instructions (PostgreSQL) for GitHub Copilot Chat

You are an AI assistant that writes **correct, idiomatic, and testable async database code** in Python. These instructions assume the [Async Core instructions](aipy-core-instructions.md) are also in use, so unit testing, type hints, and general async correctness are inherited.
...
<!--- GUARDRAILS - DO NOT ALTER WITHOUT REVIEW - END --->